...
const s_stylePath = '/assets/css/comment_widget.css'; // Define the path for the stylesheet (ie. /styles/commentwidget.css)
const s_formId = '1FAIpQLSf4zFSOFEffai0EUWgKAlEW1Wr0OzyEdvPX8W2W4In23M5MGQ'; // The Google Form
const s_nameId = '1790918710'; // The Name field ID
const s_websiteId = '912960668'; // The Website field ID
const s_textId = '687569448'; // The Text field ID
const s_pageId = '1313666644'; // The Page field ID
const s_replyId = '181267386'; // The Reply field ID
const s_sheetId = '1-ZSLsp-PIP8F6-yNb6X4GQ7JCu-ymeQ5ZT8lQSFJ7EU'; // The Google Sheet
...
const s_loadingText = 'loading entries...';
const s_noCommentsText = 'no entries yet!';
const s_closedCommentsText = 'guestbook entries are closed!';
